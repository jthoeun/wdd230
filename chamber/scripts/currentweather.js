...
function displayResults(data) {
    ...
    const weatherContainer = document.createElement('div'); // Create a container
    weatherContainer.classList.add('weather-info'); // Add a class for styling
    weatherContainer.appendChild(captionDec); // Add description first
    weatherContainer.appendChild(currentTemp); // Add temperature next
    weatherIcon.parentElement.insertBefore(weatherContainer, weatherIcon.nextSibling); // Insert container after icon
}
